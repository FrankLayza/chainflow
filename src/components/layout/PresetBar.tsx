  ...
  return (
    <div className="w-full bg-deep-ember border-b border-iron-veil px-6 py-3">
      <div className="max-w-350 mx-auto flex items-center justify-between gap-3">
        <div className="flex items-center gap-2 text-caption-tracked uppercase text-bone-gray font-mono">
        ...
        <div className="flex items-center gap-2">
          {PRESET_RULES.map((preset) => (
            <button
              ...
              disabled={disabled}
              className="flex items-center gap-2 px-3 py-1.5 rounded-md bg-smoke-charcoal border border-iron-veil text-warm-off-white text-sm transition-colors duration-150 hover:bg-slate-hearth hover:border-pale-stone disabled:opacity-40"
            >
